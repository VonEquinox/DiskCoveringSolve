...
import force15 as G
R=Path(__file__).resolve().parent;OUT=R/'forest15';OUT.mkdir(exist_ok=True)
ROWS=json.load(open(R/'metric15_residuals.json'));CAND=json.load(open(R/'candidate15_map.json'))['residual_index']
