...
GAMMA=300; LAMBDA=F(13,10000); NU=F(1,80)
BUFFER=F(1,10**8); EPS=F(2,Q); RADIUS=F(1,9)
...
def main():
 ...
 out={'verified':True,'theorem':'Any realization of the 61-rod candidate graph with all rods <= r_star, unit anchors, fixed q0=(1,0), and ||Q-Q_star||_F <=1/9, is the candidate itself.',
 'gamma':GAMMA,'lambda':str(LAMBDA),'nu_upper':str(NU),'anchor_Frobenius_radius':str(RADIUS),
 'per_anchor_angle_halfwidth':str(F(1,30)),
