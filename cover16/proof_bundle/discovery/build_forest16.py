...
R=Path(__file__).resolve().parent;OUT=R/'forest16';OUT.mkdir(exist_ok=True)
ROWS=json.load(open(R/'metric16_residuals.json'));CAND=json.load(open(R/'candidate16_map.json'))['residual_index']
