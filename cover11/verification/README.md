...
- Date: 2026-09-04
- Integrity target: 168 fixed files in `cover11/proof_bundle/SHA256SUMS`.
...
temporary copy of `cover11/proof_bundle`; the portable wrapper changed only hard-coded
