...
BMIN=11; N=18; V=52;QL=10**15;DF=10**36
A=937111;C=1970786;C6=3362065;D=10000000;RU=F('0.29016771764058')
...
if __name__=='__main__':
 rr=json.load(open(R/'metric18_residuals.json'));st=time.time()
