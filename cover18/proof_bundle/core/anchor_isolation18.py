...
GAMMA=400; LAMBDA=F(69,50000); NU=F(14,1250)
BUFFER=F(1,10**8); EPS=F(2,Q); RADIUS=F(7,60)
...
def prepare():
 ...
 dA=500*EPS; dM=(2*max(degree)+1)*EPS
...
def main():
 ...
 out={'verified':True,'theorem':'Any realization of the 72-rod candidate graph with all rods <= r_star, unit anchors, fixed q0=(1,0), and ||Q-Q_star||_F <=7/60, is the candidate itself.',
