...
import force14 as G
R=Path(__file__).resolve().parent;OUT=R/'forest14';OUT.mkdir(exist_ok=True)
ROWS=json.load(open(R/'metric14_residuals.json'));CAND=json.load(open(R/'candidate14_map.json'))['residual_index']
