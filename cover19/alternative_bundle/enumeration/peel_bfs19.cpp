/* Independent root-face enumeration and integer angular pruning, n=19.
...
#include <vector>
using namespace std;
constexpr int MAXV=19,MAXT=25;
constexpr long long UNIT=10000000, ARC=894563, TWO=1871672, THREE=3128331;
