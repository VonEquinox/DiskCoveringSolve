...
import force_fast19 as G
R=Path(__file__).resolve().parent;OUT=R/'forest19';OUT.mkdir(exist_ok=True)
ROWS=json.load(open(R/'metric19_residuals.json'));CAND=json.load(open(R/'candidate19_map.json'))['residual_index']
