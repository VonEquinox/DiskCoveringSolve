...
BMIN=12; N=20; V=58;QL=10**15;DF=10**36
A=873043;C=1822179;C6=3019184;D=10000000;RU=F('0.27084817843999')
...
from compact_force20 import check,rationalize
...
if __name__=='__main__':
 rr=json.load(open(R/'metric20_residuals.json'));st=time.time()
